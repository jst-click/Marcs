import { getMailtoLink, getTelLink, getWhatsAppLink } from '../../lib/contactLinks';

export function FloatingContactButtons() {
  return (
    <div
      className="fixed bottom-4 right-3 sm:bottom-5 sm:right-5 z-50 flex flex-col gap-2.5 sm:gap-3"
    ...
    >
      ...
      <a
        ...
        className="group flex items-center justify-center gap-2 rounded-full bg-[#25D366] p-3 sm:pl-4 sm:pr-5 sm:py-3 text-white shadow-lg shadow-green-900/30 hover:bg-[#20bd5a] hover:scale-105 transition-all"
        aria-label="Chat on WhatsApp"
      >
        <svg className="w-5 h-5 sm:w-6 sm:h-6 shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
