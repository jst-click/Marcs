...
export function FloatingContactButtons() {
  return (
    ...
    >
      <a
        href={getMailtoLink()}
        className="group flex items-center gap-2 rounded-full bg-[#EA4335] pl-4 pr-5 py-3 text-white shadow-lg shadow-red-900/30 hover:bg-[#d33b2e] hover:scale-105 transition-all"
      ...
      <a
        ...
        className="group flex items-center gap-2 rounded-full bg-[#25D366] pl-4 pr-5 py-3 text-white shadow-lg shadow-green-900/30 hover:bg-[#20bd5a] hover:scale-105 transition-all"
